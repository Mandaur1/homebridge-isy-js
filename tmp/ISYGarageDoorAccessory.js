...
class ISYGarageDoorAccessory extends ISYAccessory_1.ISYAccessory {
    ...
    setupServices() {
        ...
        garageDoorService.getCharacteristic(hap_nodejs_1.Characteristic.TargetDoorState).on("set" /* SET */, this.setTargetDoorState.bind(this));
        garageDoorService.getCharacteristic(hap_nodejs_1.Characteristic.TargetDoorState).on("get" /* GET */, this.getTargetDoorState.bind(this));
        garageDoorService.getCharacteristic(hap_nodejs_1.Characteristic.CurrentDoorState).on("get" /* GET */, this.getCurrentDoorState.bind(this));
        garageDoorService.getCharacteristic(hap_nodejs_1.Characteristic.CurrentDoorState).on("set" /* SET */, this.setCurrentDoorState.bind(this));
        garageDoorService.getCharacteristic(hap_nodejs_1.Characteristic.ObstructionDetected).on("get" /* GET */, this.getObstructionState.bind(this));
    }
}
