...
class ISYDimmableAccessory extends ISYRelayAccessory_1.ISYRelayAccessory {
    ...
    setupServices() {
        ...
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.On).onGet(() => this.device.isOn);
        ...
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.Brightness).onSet(this.bind(this.device.updateBrightnessLevel)).updateValue(this.device.OL);
