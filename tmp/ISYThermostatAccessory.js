...
class ISYThermostatAccessory extends ISYDeviceAccessory_1.ISYDeviceAccessory {
    ...
    setupServices() {
        ...
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.CurrentFanState).on("get" /* GET */, (f) => this.getFanMode(f));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.CurrentTemperature).on("get" /* GET */, this.getCurrentTemperature.bind(this));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.CoolingThresholdTemperature).on("get" /* GET */, this.getCoolSetPoint.bind(this));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.CoolingThresholdTemperature).on("set" /* SET */, this.setCoolSetPoint.bind(this));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.HeatingThresholdTemperature).on("get" /* GET */, this.getHeatSetPoint.bind(this));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.HeatingThresholdTemperature).on("set" /* SET */, this.setHeatSetPoint.bind(this));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.CurrentHeatingCoolingState).on("get" /* GET */, this.getOperatingMode.bind(this));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.TargetHeatingCoolingState).on("get" /* GET */, this.getMode.bind(this));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.TargetHeatingCoolingState).on("set" /* SET */, this.setHeatingCoolingMode.bind(this));
        this.primaryService.getCharacteristic(hap_nodejs_1.Characteristic.CurrentRelativeHumidity).on("get" /* GET */, this.getHumidity.bind(this));
        // primaryService
