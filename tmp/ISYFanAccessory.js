...
class ISYFanAccessory extends ISYDeviceAccessory_1.ISYDeviceAccessory {
    ...
    map(propertyName, propertyValue) {
        ...
        if (propertyName === 'motor.ST') {
            return { characteristicValue: propertyValue, characteristic: hap_nodejs_1.Characteristic.RotationSpeed, service: this.fanService };
        }
        else if (propertyName === 'light.ST') {
            return { characteristicValue: propertyValue, characteristic: hap_nodejs_1.Characteristic.Brightness, service: this.lightService };
        }
    }
